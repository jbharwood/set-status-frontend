...
export async function getProductionRoleCaptureStatuses(params?: {
  companyId?: number;
  stageId?: number;
  isActive?: boolean;
}) {
...
export async function getProductionRoleCaptureStatusesHistory(params: {
  companyId: number;
  stageId: number;
}) {
  const queryParams = new URLSearchParams();
...
export async function getStageCaptureStatuses(companyId: number) {
  const queryParams = new URLSearchParams();
  queryParams.append("companyId", companyId.toString());
...
export async function getStageCaptureStatus(
  stageId: number,
  companyId: number
) {
  const queryParams = new URLSearchParams();
